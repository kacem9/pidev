<?php
	...
	class User extends BaseUser
	{
        ...
        /**
         * @ORM\OneToMany(targetEntity="AppBundle\Entity\Velo", mappedBy="user",cascade={"remove"})
         */
        private $velo;
        /**
         * @ORM\OneToMany(targetEntity="AppBundle\Entity\produits", mappedBy="user",cascade={"remove"})
         */
        private $produits;
