...
{
    public function removePanierAction(SessionInterface $session,$id,$nre)
{
    $em=$this->getDoctrine()->getManager();
    $pt=$em->getRepository(Produit::class)->find($id);
    $pt->setQte($pt->getQte()+($nre+0));
    $em->persist($pt);
    $em->flush();
